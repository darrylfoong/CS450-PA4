...
_file_test2:     file format elf32-i386
...
save(void)
{
  ...
  45:	c7 44 24 04 74 08 00 	movl   $0x874,0x4(%esp)
  4c:	00 
  ...
  60:	00 
  61:	c7 44 24 04 4f 08 00 	movl   $0x84f,0x4(%esp)
  68:	00 
  ...
  76:	c7 44 24 08 3c 00 00 	movl   $0x3c,0x8(%esp)
  7d:	00 
  7e:	c7 44 24 04 f4 08 00 	movl   $0x8f4,0x4(%esp)
  85:	00 
  86:	89 1c 24             	mov    %ebx,(%esp)
  89:	e8 96 03 00 00       	call   424 <write>
  8e:	83 f8 3c             	cmp    $0x3c,%eax
  91:	75 22                	jne    b5 <save+0x95>
    ...
    printf(1, "write ok\n");
  93:	c7 44 24 04 56 08 00 	movl   $0x856,0x4(%esp)
  9a:	00 
  ...
  b4:	c3                   	ret    
    ...
    if(write(fd, "worlddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd ", 60) != 60){
        printf(1, "error: write to small_overflow file failed\n");
  b5:	c7 44 24 04 c8 08 00 	movl   $0x8c8,0x4(%esp)
  bc:	00 
  ...
  c9:	e8 36 03 00 00       	call   404 <exit>
    ...
    if(fd >= 0) {
        ...
        printf(1, "error: create small_overflow file failed\n");
  ce:	c7 44 24 04 9c 08 00 	movl   $0x89c,0x4(%esp)
  d5:	00 
...
load(void)
{
 ...
 116:	8d 75 ec             	lea    -0x14(%ebp),%esi
    ...
    if(fd >= 0) {
        printf(1, "ok: read small_overflow file succeed\n");
 119:	c7 44 24 04 3c 09 00 	movl   $0x93c,0x4(%esp)
 120:	00 
 ...
 149:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
 150:	00 
 ...
 166:	c7 44 24 04 60 08 00 	movl   $0x860,0x4(%esp)
 16d:	00 
 16e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 175:	e8 e6 03 00 00       	call   560 <printf>

    printf(1, "read ok\n");
 17a:	c7 44 24 04 69 08 00 	movl   $0x869,0x4(%esp)
 181:	00 
 ...
 19c:	c3                   	ret    
    ...
    if(read(fd, dst + 6, 5) != 5) {
        printf(1, "error: read from small_overflow file failed\n");
 19d:	c7 44 24 04 8c 09 00 	movl   $0x98c,0x4(%esp)
 1a4:	00 
 ...
 1b1:	e8 4e 02 00 00       	call   404 <exit>
    ...
    if(fd >= 0) {
        ...
        printf(1, "error: read small_overflow file failed\n");
 1b6:	c7 44 24 04 64 09 00 	movl   $0x964,0x4(%esp)
 1bd:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	f7 f1                	div    %ecx
 50e:	0f b6 92 c3 09 00 00 	movzbl 0x9c3(%edx),%edx
  }while((x /= base) != 0);
 ...
 577:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 640:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 643:	b8 bc 09 00 00       	mov    $0x9bc,%eax
...
free(void *ap)
{
 ...
 6c1:	a1 c0 0c 00 00       	mov    0xcc0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 70f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 711:	a3 c0 0c 00 00       	mov    %eax,0xcc0
}
 716:	5b                   	pop    %ebx
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 ...
 732:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 735:	a3 c0 0c 00 00       	mov    %eax,0xcc0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 75c:	8b 15 c0 0c 00 00    	mov    0xcc0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 797:	76 57                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 799:	3b 05 c0 0c 00 00    	cmp    0xcc0,%eax
...
morecore(uint nu)
{
 ...
 7cd:	e8 ee fe ff ff       	call   6c0 <free>
  return freep;
 7d2:	8b 15 c0 0c 00 00    	mov    0xcc0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 c0 0c 00 00 c4 	movl   $0xcc4,0xcc0
 81d:	0c 00 00 
    base.s.size = 0;
 820:	b8 c4 0c 00 00       	mov    $0xcc4,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 825:	c7 05 c4 0c 00 00 c4 	movl   $0xcc4,0xcc4
 82c:	0c 00 00 
    base.s.size = 0;
 82f:	c7 05 c8 0c 00 00 00 	movl   $0x0,0xcc8
 836:	00 00 00 
