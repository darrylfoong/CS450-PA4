...
save(void)
{
  ...
  7d:	00 
  7e:	c7 44 24 04 51 08 00 	movl   $0x851,0x4(%esp)
  85:	00 
  ...
  91:	75 22                	jne    b5 <save+0x95>
    ...
    printf(1, "write ok\n");
  93:	c7 44 24 04 57 08 00 	movl   $0x857,0x4(%esp)
  9a:	00 
...
load(void)
{
 ...
 116:	8d 75 ec             	lea    -0x14(%ebp),%esi
    ...
    if(fd >= 0) {
        printf(1, "ok: read small file succeed\n");
 119:	c7 44 24 04 61 08 00 	movl   $0x861,0x4(%esp)
 120:	00 
 ...
 166:	c7 44 24 04 7e 08 00 	movl   $0x87e,0x4(%esp)
 16d:	00 
 16e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 175:	e8 e6 03 00 00       	call   560 <printf>

    printf(1, "read ok\n");
 17a:	c7 44 24 04 87 08 00 	movl   $0x887,0x4(%esp)
 181:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	f7 f1                	div    %ecx
 50e:	0f b6 92 43 09 00 00 	movzbl 0x943(%edx),%edx
  }while((x /= base) != 0);
 ...
 577:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 640:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 643:	b8 3c 09 00 00       	mov    $0x93c,%eax
...
free(void *ap)
{
 ...
 70f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 711:	a3 40 0c 00 00       	mov    %eax,0xc40
}
 716:	5b                   	pop    %ebx
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 ...
 732:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 735:	a3 40 0c 00 00       	mov    %eax,0xc40
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 797:	76 57                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 799:	3b 05 40 0c 00 00    	cmp    0xc40,%eax
...
morecore(uint nu)
{
 ...
 7cd:	e8 ee fe ff ff       	call   6c0 <free>
  return freep;
 7d2:	8b 15 40 0c 00 00    	mov    0xc40,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 7ff:	89 15 40 0c 00 00    	mov    %edx,0xc40
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
        return 0;
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 40 0c 00 00 44 	movl   $0xc44,0xc40
 81d:	0c 00 00 
    base.s.size = 0;
 820:	b8 44 0c 00 00       	mov    $0xc44,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 825:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 82c:	0c 00 00 
    base.s.size = 0;
 82f:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 836:	00 00 00 
