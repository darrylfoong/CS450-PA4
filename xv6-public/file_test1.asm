...
_file_test1:     file format elf32-i386
...
save(void)
{
  ...
  45:	c7 44 24 04 94 08 00 	movl   $0x894,0x4(%esp)
  4c:	00 
  ...
  60:	00 
  61:	c7 44 24 04 4b 08 00 	movl   $0x84b,0x4(%esp)
  68:	00 
  ...
  7d:	00 
  7e:	c7 44 24 04 52 08 00 	movl   $0x852,0x4(%esp)
  85:	00 
  ...
  91:	75 22                	jne    b5 <save+0x95>
    ...
    printf(1, "write ok\n");
  93:	c7 44 24 04 58 08 00 	movl   $0x858,0x4(%esp)
  9a:	00 
  ...
  b4:	c3                   	ret    
    ...
    if(write(fd, "world", 5) != 5){
        printf(1, "error: write to ordinary file failed\n");
  b5:	c7 44 24 04 d8 08 00 	movl   $0x8d8,0x4(%esp)
  bc:	00 
  ...
  c9:	e8 36 03 00 00       	call   404 <exit>
    ...
    if(fd >= 0) {
        ...
        printf(1, "error: create normal file failed\n");
  ce:	c7 44 24 04 b4 08 00 	movl   $0x8b4,0x4(%esp)
  d5:	00 
...
load(void)
{
 ...
 116:	8d 75 ec             	lea    -0x14(%ebp),%esi
    ...
    if(fd >= 0) {
        printf(1, "ok: read normal file succeed\n");
 119:	c7 44 24 04 62 08 00 	movl   $0x862,0x4(%esp)
 120:	00 
 ...
 166:	c7 44 24 04 80 08 00 	movl   $0x880,0x4(%esp)
 16d:	00 
 16e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 175:	e8 e6 03 00 00       	call   560 <printf>

    printf(1, "read ok\n");
 17a:	c7 44 24 04 89 08 00 	movl   $0x889,0x4(%esp)
 181:	00 
 ...
 19c:	c3                   	ret    
    ...
    if(read(fd, dst + 6, 5) != 5) {
        printf(1, "error: read from normal file failed\n");
 19d:	c7 44 24 04 20 09 00 	movl   $0x920,0x4(%esp)
 1a4:	00 
 ...
 1b1:	e8 4e 02 00 00       	call   404 <exit>
    ...
    if(fd >= 0) {
        ...
        printf(1, "error: read normal file failed\n");
 1b6:	c7 44 24 04 00 09 00 	movl   $0x900,0x4(%esp)
 1bd:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	f7 f1                	div    %ecx
 50e:	0f b6 92 4f 09 00 00 	movzbl 0x94f(%edx),%edx
  }while((x /= base) != 0);
 ...
 577:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 640:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 643:	b8 48 09 00 00       	mov    $0x948,%eax
...
free(void *ap)
{
 ...
 6c1:	a1 4c 0c 00 00       	mov    0xc4c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 70f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 711:	a3 4c 0c 00 00       	mov    %eax,0xc4c
}
 716:	5b                   	pop    %ebx
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 ...
 732:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 735:	a3 4c 0c 00 00       	mov    %eax,0xc4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 75c:	8b 15 4c 0c 00 00    	mov    0xc4c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 797:	76 57                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 799:	3b 05 4c 0c 00 00    	cmp    0xc4c,%eax
...
morecore(uint nu)
{
 ...
 7cd:	e8 ee fe ff ff       	call   6c0 <free>
  return freep;
 7d2:	8b 15 4c 0c 00 00    	mov    0xc4c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 7ff:	89 15 4c 0c 00 00    	mov    %edx,0xc4c
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
        return 0;
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 4c 0c 00 00 50 	movl   $0xc50,0xc4c
 81d:	0c 00 00 
    base.s.size = 0;
 820:	b8 50 0c 00 00       	mov    $0xc50,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 825:	c7 05 50 0c 00 00 50 	movl   $0xc50,0xc50
 82c:	0c 00 00 
    base.s.size = 0;
 82f:	c7 05 54 0c 00 00 00 	movl   $0x0,0xc54
 836:	00 00 00 
